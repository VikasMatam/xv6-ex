...
80103a99:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
      ...
      swtch(&(c->scheduler), p->context);
80103aa0:	e8 26 0c 00 00       	call   801046cb <swtch>
      switchkvm();
80103aa5:	e8 b6 2d 00 00       	call   80106860 <switchkvm>
...
80103ac8:	e8 53 09 00 00       	call   80104420 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ae5:	e8 a6 07 00 00       	call   80104290 <pushcli>
  c = mycpu();
80103aea:	e8 e1 fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103aef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103af5:	e8 d6 07 00 00       	call   801042d0 <popcli>
sched(void)
{
  int intena;
...
80103b02:	e8 39 08 00 00       	call   80104340 <holding>
...
80103b43:	e8 83 0b 00 00       	call   801046cb <swtch>
  mycpu()->intena = intena;
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103ba9:	e8 e2 06 00 00       	call   80104290 <pushcli>
  c = mycpu();
80103bae:	e8 1d fb ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103bb3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bb9:	e8 12 07 00 00       	call   801042d0 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103c12:	e8 59 07 00 00       	call   80104370 <acquire>
...
80103cdc:	e8 8f 06 00 00       	call   80104370 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103ce1:	e8 aa 05 00 00       	call   80104290 <pushcli>
  c = mycpu();
80103ce6:	e8 e5 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103ceb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cf1:	e8 da 05 00 00       	call   801042d0 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d09:	e8 12 07 00 00       	call   80104420 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d2f:	e8 5c 05 00 00       	call   80104290 <pushcli>
  c = mycpu();
80103d34:	e8 97 f9 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103d39:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d3f:	e8 8c 05 00 00       	call   801042d0 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d60:	e8 0b 06 00 00       	call   80104370 <acquire>
    release(lk);
80103d65:	89 34 24             	mov    %esi,(%esp)
80103d68:	e8 b3 06 00 00       	call   80104420 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d8a:	e8 91 06 00 00       	call   80104420 <release>
    acquire(lk);
...
80103d9b:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103d9c:	e9 cf 05 00 00       	jmp    80104370 <acquire>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103de5:	e8 a6 04 00 00       	call   80104290 <pushcli>
  c = mycpu();
80103dea:	e8 e1 f8 ff ff       	call   801036d0 <mycpu>
  p = c->proc;
80103def:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103df5:	e8 d6 04 00 00       	call   801042d0 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103e02:	e8 69 05 00 00       	call   80104370 <acquire>
...
80103e70:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e77:	e8 84 2d 00 00       	call   80106c00 <freevm>
        p->pid = 0;
...
80103ea3:	e8 78 05 00 00       	call   80104420 <release>
        return pid;
...
80103ebc:	e8 5f 05 00 00       	call   80104420 <release>
      return -1;
...
80103edf:	e8 8c 04 00 00       	call   80104370 <acquire>
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f21:	e9 fa 04 00 00       	jmp    80104420 <release>
...
80103f74:	e8 a7 04 00 00       	call   80104420 <release>
      return 0;
...
80103fa0:	e8 7b 04 00 00       	call   80104420 <release>
  return -1;
...
80104008:	8b 14 85 b0 75 10 80 	mov    -0x7fef8a50(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
80104045:	e8 e6 01 00 00       	call   80104230 <getcallerpcs>
...
80104095:	74 28                	je     801040bf <cps+0x3f>
      continue;
   if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
...
801040a1:	8b 14 85 b0 75 10 80 	mov    -0x7fef8a50(,%eax,4),%edx
      state = states[p->state];
   else
      state = "???";
...
801040bf:	83 c3 7c             	add    $0x7c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040c2:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
801040c8:	75 c6                	jne    80104090 <cps+0x10>
   else
      state = "???";
   cprintf("(%d, %s, %s)\n", p->pid,state, p->name);
  }
...
801040cd:	b8 01 00 00 00       	mov    $0x1,%eax
801040d2:	5b                   	pop    %ebx
801040d3:	5e                   	pop    %esi
801040d4:	5d                   	pop    %ebp
801040d5:	c3                   	ret    
801040d6:	66 90                	xchg   %ax,%ax
...
80104145:	e8 d6 fb ff ff       	call   80103d20 <sleep>
...
801041a4:	e8 27 fd ff ff       	call   80103ed0 <wakeup>
  release(&lk->lk);
...
801054d3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054d6:	e8 c5 e6 ff ff       	call   80103ba0 <exit>
...
{
  return wait();
801054e4:	e9 f7 e8 ff ff       	jmp    80103de0 <wait>
...
8010550e:	e8 1d ea ff ff       	call   80103f30 <kill>
...
801055dd:	e8 3e e7 ff ff       	call   80103d20 <sleep>
...
{
  return cps();
80105674:	e9 07 ea ff ff       	jmp    80104080 <cps>
...
8010587b:	75 a8                	jne    80105825 <trap+0xb5>
    exit();
8010587d:	e8 1e e3 ff ff       	call   80103ba0 <exit>
...
8010588c:	75 ab                	jne    80105839 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
8010588e:	e8 3d e4 ff ff       	call   80103cd0 <yield>
...
8010593f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105940:	e9 5b e2 ff ff       	jmp    80103ba0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105948:	e8 53 e2 ff ff       	call   80103ba0 <exit>
...
80105964:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
8010596b:	e8 60 e5 ff ff       	call   80103ed0 <wakeup>
      release(&tickslock);
